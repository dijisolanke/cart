...
interface CartProps {
  itemCount: number;
  toggleOverlay: () => void; // Receive the toggle function as a prop
}

const CartComponent = ({ itemCount, toggleOverlay }: CartProps) => {
  return (
    <div className="container">
      {/* Circle with the number */}
      <div className="cartCounter">{itemCount}</div>
...
// const CartComponent = ({ itemCount }: CartProps) => {
//   return (
//     <div className="container">
//       {/* Circle with the number */}
//       <div className="cartCounter">{itemCount}</div>
